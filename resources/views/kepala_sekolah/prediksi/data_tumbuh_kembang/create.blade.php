            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('tumbuh_kembang.index') }}">Tumbuh Kembang</a>
                        </li>
                ...
                <div class="card border-0 shadow-lg rounded-3">
                    <div class="card-header bg-gradient-success text-white text-center rounded-top-3">
                        <h4 class="mb-0 fw-bold">
                            <i class="bi bi-plus-square-fill me-2"></i> Tambah Data Tumbuh Kembang
                        </h4>
                    </div>
                    <div class="card-body px-5 py-4">
                        <form action="{{ route('tumbuh_kembang.store') }}" method="POST" novalidate>
                            @csrf
                            ...
                            <div class="mb-4">
                                ...
                                <select name="id_siswa" id="id_siswa"
                                    ...
                                    @foreach($siswa as $item)
                                        <option value="{{ $item->id }}" {{ old('id_siswa') == $item->id ? 'selected' : '' }}>
                                            {{ $item->nama_lengkap }}
                                        </option>
                                    @endforeach
                                </select>
