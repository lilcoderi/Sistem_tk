            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('data-siswa.create') }}">Tambah Data Siswa</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="id_pendaftaran" value="{{ old('id_pendaftaran') }}"
                            class="form-control">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat_rumah" class="form-control">{{ old('alamat_rumah') }}</textarea>
                    </div>
                    <div class="mb-3">
                        <label>Agama</label>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="kelompok" value="{{ old('kelompok') }}" class="form-control">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label>Anak Ke</label>
                        <input type="number" name="anak_ke" value="{{ old('anak_ke') }}" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label>Bahasa Sehari-hari</label>
                        <input type="text" name="bahasa_sehari_hari" value="{{ old('bahasa_sehari_hari') }}"
                            class="form-control">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="ciri_khusus" class="form-control">{{ old('ciri_khusus') }}</textarea>
                    </div>
                </div>
            </div>
