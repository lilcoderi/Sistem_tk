            ...
            <div class="col-md-5">
                <div class="card shadow-sm border-success h-100 d-flex flex-column">
                                        ...
                                        <div class="d-flex justify-content-between align-items-start">
                                            ...
                                            <div class="ms-2 text-end">
                                                ...
                                                <form action="{{ route('kegiatan.destroy', $kegiatan->id) }}" method="POST"
                                                    onsubmit="return confirmHapusUmum(event, this, 'Kegiatan ini akan dihapus secara permanen.')">
                                                    @csrf
                                                    @method('DELETE')
                    ...
                    <div class="card-footer bg-light text-end">
                        <a href="{{ route('kegiatan.create') }}" class="btn btn-sm btn-success shadow-sm">
